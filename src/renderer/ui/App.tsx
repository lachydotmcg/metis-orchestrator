...
// The benchmark's data tables moved to ./benchmark-data.ts (2026-08-20,
// docs/STRUCTURAL_DEBT.md item 1). Pure data, no React — the category that is
// 28% of this file and needs no dependency injection to move, because there is
// nothing to inject. It is also the data docs/OPEN_QUESTIONS.md asks about,
// which is easier to see in a 90-line file than at line 1,023 of an
// 18,000-line one.
...
// The canvas arithmetic — colour assignment, force-directed layout, and route
// geometry — moved to ./graph-maths.ts (2026-08-20, docs/STRUCTURAL_DEBT.md
// item 1). It was two ranges 8,000 lines apart that are the same subject, both
// measured at zero dependencies on the rest of this file.
