...
declare global {
  ...
  interface Window {
    ...
    metisLoops?: {
      ...
      create: (input: { goal: string; projectPath?: string; maxIterations?: number; permissionMode?: string; fixedIntervalSeconds?: number; budgetTokens?: number; steps?: (string | string[])[] }) => Promise<LoopRecord>;
